		...
		<div class="user-info-div">
			<div style={{ margin: "2rem"}}>
				<div style={{ display: "flex", justifyContent: "left"}}>
					<p style={{ width: "100%", fontSize: "110%" }}>Datian Tein Dang</p>
