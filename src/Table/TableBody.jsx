...
function TableBody() {
  ...
  return (
    ...
    {tickets.map( (ticket) => {
      return <RowItem id = {ticket.ticket_id} date={ticket.issue_date} sellerID = {ticket.seller_id} module={ticket.module} details={ticket.description} status={ticket.status}/>
    })}
